...
namespace Alphasky\Api\Facades;

use Alphasky\Api\Supports\ApiHelper as ApiHelperSupport;
use Illuminate\Support\Facades\Facade;

/**
 * @method static string modelName()
 * @method static \Alphasky\Api\Supports\ApiHelper setModelName(string $modelName)
 ...
 *
 * @see \Alphasky\Api\Supports\ApiHelper
 */
