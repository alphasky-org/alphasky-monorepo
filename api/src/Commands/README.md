...
This directory contains commands for managing push notifications in the Alphasky CMS API package.
...
- `--user-type` - User type when target is user (member, admin) [default: member]
...
- `user_type` - Send to specific user type (member/admin)
