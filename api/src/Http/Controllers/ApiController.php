...
use Alphasky\Api\Forms\Settings\ApiSettingForm;
use Alphasky\Api\Http\Requests\ApiSettingRequest;
use Alphasky\Api\Http\Requests\SendNotificationRequest;
...
class ApiController extends SettingController
{
    ...
    public function sendNotification(SendNotificationRequest $request, BaseHttpResponse $response)
    {
        ...
        $result = match ($target) {
            ...
            'members' => $pushService->sendToUserType('member', $notification),
