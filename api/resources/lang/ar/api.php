...
return [
    ...
    'generate_docs_description' => 'لإنشاء وثائق API لتطبيق Alphasky CMS الخاص بك، اتبع هذه الخطوات البسيطة:',
    ...
    'fcm_project_id_description' => 'معرف مشروع Firebase الخاص بك من Firebase Console (إعدادات المشروع > عام). مثال: my-app-12345.',
    ...
    'fcm_service_account_upload_description' => 'قم بتحميل ملف JSON لحساب خدمة Firebase. يقوم هذا الملف بمصادقة الخادم الخاص بك مع Firebase لإرسال الإشعارات. قم بتنزيله من Firebase Console > إعدادات المشروع > حسابات الخدمة > إنشاء مفتاح خاص جديد.',
    ...
    'member_devices' => 'أجهزة العملاء فقط',
    ...
    'api_key_enabled_status' => 'حماية مفتاح API <strong>مفعلة</strong>. جميع الطلبات تتطلب رأس X-API-KEY.',
    'api_key_disabled_status' => 'حماية مفتاح API <strong>معطلة</strong>. يمكن لأي عميل الوصول إلى API بدون مفتاح API.',
    'api_security_section_description' => 'يعمل مفتاح API كسر مشترك بين الخادم والعملاء (مثل تطبيق الهاتف المحمول). يمنع العملاء غير المعروفين من الوصول إلى API. لا تزال هوية المستخدم تتم معالجتها بشكل منفصل بواسطة رموز Sanctum.',
    'push_notifications_section_description' => 'إرسال إشعارات فورية إلى مستخدمي تطبيق الهاتف المحمول عبر Firebase Cloud Messaging. يتطلب هذا تطبيق هاتف محمول يسجل رموز الأجهزة مع API الخاص بك.',
    'send_custom_notification_description' => 'إرسال إشعار فوري إلى مستخدمي تطبيق الهاتف المحمول المسجلين. يتم تسليم الإشعارات عبر Firebase Cloud Messaging إلى الأجهزة التي سجلت رموزها.',
    'no_device_tokens' => 'لم يتم العثور على رموز أجهزة نشطة',
    'no_device_tokens_description' => 'يتم تسجيل رموز الأجهزة تلقائياً عندما يفتح المستخدمون تطبيق الهاتف المحمول. تعني هذه الرسالة أنه لم يتصل أي تطبيق هاتف محمول بـ API الخاص بك بعد. بمجرد نشر التطبيق وفتحه من قبل المستخدمين، ستظهر رموز الأجهزة هنا.',
    'device_tokens_stats' => 'رموز الأجهزة النشطة',
    'fcm_ready' => 'تم تكوين Firebase. الإشعارات الفورية جاهزة للاستخدام.',
    'fcm_not_configured' => 'Firebase غير مكوّن بالكامل. أكمل الإعداد أعلاه لتمكين الإشعارات الفورية.',
    'service_account_file' => 'ملف حساب الخدمة:',
    ...
    'will_send_to_devices' => 'سيتم الإرسال إلى :total جهاز نشط (:android Android، :ios iOS، :members عملاء)',
    'close' => 'إغلاق',
];
