...
return [
    ...
    'generate_docs_description' => 'Um die API-Dokumentation für Ihre Alphasky CMS-Anwendung zu generieren, folgen Sie diesen einfachen Schritten:',
    ...
    'fcm_project_id_description' => 'Ihre Firebase-Projekt-ID aus der Firebase Console (Projekteinstellungen > Allgemein). Beispiel: my-app-12345.',
    'fcm_project_id_placeholder' => 'z.B. my-app-12345',
    ...
    'fcm_service_account_upload_description' => 'Laden Sie Ihre Firebase-Service-Account-JSON-Datei hoch. Diese Datei authentifiziert Ihren Server bei Firebase, um Benachrichtigungen zu senden. Laden Sie sie von Firebase Console > Projekteinstellungen > Service-Accounts > Neuen privaten Schlüssel generieren herunter.',
    ...
    'member_devices' => 'Nur Kundengeräte',
    ...
    'fcm_step_2_4' => 'Laden Sie sie über die Schaltfläche oben hoch oder legen Sie sie in storage/app/firebase/ ab',
    'fcm_step_3_title' => '3. FCM-API aktivieren',
    'fcm_step_3_1' => 'Gehen Sie zur Google Cloud Console',
    'fcm_step_3_2' => 'Aktivieren Sie Firebase Cloud Messaging API (V1)',
    ...
    'fcm_step_4_2' => 'Laden Sie Ihre Service-Account-JSON-Datei hoch',
    ...
    'api_key_enabled_status' => 'Der API-Schlüsselschutz ist <strong>aktiviert</strong>. Alle Anfragen benötigen den X-API-KEY-Header.',
    'api_key_disabled_status' => 'Der API-Schlüsselschutz ist <strong>deaktiviert</strong>. Jeder Client kann ohne API-Schlüssel auf die API zugreifen.',
    'api_security_section_description' => 'Der API-Schlüssel fungiert als gemeinsames Geheimnis zwischen Ihrem Server und Clients (z.B. Ihrer mobilen App). Er verhindert, dass unbekannte Clients auf die API zugreifen. Die Benutzeridentität wird weiterhin separat durch Sanctum-Tokens verwaltet.',
    'push_notifications_section_description' => 'Senden Sie Push-Benachrichtigungen an Ihre mobilen App-Benutzer über Firebase Cloud Messaging. Dies erfordert eine mobile App, die Geräte-Tokens bei Ihrer API registriert.',
    'send_custom_notification_description' => 'Senden Sie eine Push-Benachrichtigung an registrierte mobile App-Benutzer. Benachrichtigungen werden über Firebase Cloud Messaging an Geräte zugestellt, die ihre Tokens registriert haben.',
    'no_device_tokens' => 'Keine aktiven Geräte-Tokens gefunden',
    'no_device_tokens_description' => 'Geräte-Tokens werden automatisch registriert, wenn Benutzer Ihre mobile App öffnen. Diese Meldung bedeutet, dass sich noch keine mobile App mit Ihrer API verbunden hat. Sobald Ihre App bereitgestellt ist und Benutzer sie öffnen, werden hier Geräte-Tokens angezeigt.',
    'device_tokens_stats' => 'Aktive Geräte-Tokens',
    'fcm_ready' => 'Firebase ist konfiguriert. Push-Benachrichtigungen sind einsatzbereit.',
    'fcm_not_configured' => 'Firebase ist nicht vollständig konfiguriert. Schließen Sie die obige Einrichtung ab, um Push-Benachrichtigungen zu aktivieren.',
    'service_account_file' => 'Service-Account-Datei:',
    ...
    'will_send_to_devices' => 'Wird an :total aktive Geräte gesendet (:android Android, :ios iOS, :members Kunden)',
    'close' => 'Schließen',
];
