const ShortcodeEditPanel = {
    ...
    loadShortcodeForm(shortcode) {
        ...
        if (typeof Alphasky !== 'undefined' && Alphasky.showLoading) {
            Alphasky.showLoading(this.$content)
        }
        ...
        this.currentRequest = $.ajax({
            ...
            success: (response) => {
                this.currentRequest = null
                if (typeof Alphasky !== 'undefined') {
                    Alphasky.hideLoading(this.$content)
                }
                ...
                if (response && response.data) {
                    ...
                    setTimeout(() => {
                        if (typeof Alphasky !== 'undefined') {
                            ...
                            if (typeof Alphasky.initCoreIcon === 'function') {
                                Alphasky.initCoreIcon()
                            }

                            if (typeof Alphasky.initColorPicker === 'function') {
