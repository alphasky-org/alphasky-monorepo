...
use Alphasky\DevTool\Commands\Abstracts\BaseMakeCommand;
use Alphasky\DevTool\Helper;
use Alphasky\PluginManagement\Commands\Concern\HasPluginNameValidation;
...
class PluginCreateCommand extends BaseMakeCommand implements PromptsForMissingInput
{
    ...
    public function inputOptions(): array
    {
        return [
            'id' => [
                ...
                'placeholder' => 'E.g.: alphasky/example-plugin',
                'required' => true,
            ],
            'name' => [
                'label' => 'Name:',
    ...
    protected function registerAdvancedLanguage(): ?string
    {
        ...
        return PHP_EOL . str_repeat(' ', 12) . sprintf("if (defined('LANGUAGE_ADVANCED_MODULE_SCREEN_NAME')) {
                \Alphasky\LanguageAdvanced\Supports\LanguageAdvancedManager::registerModule(%s::class, [
                    'name',
                ]);
    ...
    protected function importsServiceProvider(): ?string
    {
        ...
        $imports = ['Alphasky\Base\Facades\DashboardMenu'];
