...
>
    ...
    <div class="get-start-wrapper">
        ...
        >
            <div class="row">
                @if (class_exists('ThemeOption') && ThemeOption::hasField('primary_color'))
                    <div class="col-sm-6">
                ...
                @if (class_exists('ThemeOption') && ThemeOption::hasField('primary_font'))
                    <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <x-core::form.text-input
                        ...
                        :value="function_exists('theme_option') ? theme_option('site_title') : ''"
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="mb-3">
                        ...
                        />
                        {!! Form::mediaImage('logo', (class_exists('Theme') ? Theme::getLogo() : ''), ['allow_thumb' => false]) !!}
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="mb-3">
                        ...
                        />
                        {!! Form::mediaImage('favicon', function_exists('theme_option') ? theme_option('favicon') : '', ['allow_thumb' => false]) !!}
                    </div>
                </div>
            </div>
