        ...
        httpClient
            ...
            .then(async ({ headers, data }) => {
                if (headers['content-disposition'] === undefined) {
                    ...
                    Alphasky.showError(responseJson?.message || $form.data('error-message'))
                ...
                Alphasky.showSuccess($form.data('success-message'))
            })
            .catch((error) => {
                Alphasky.showError(error.message ? (error.statusText + ': ' + error.message) : form.data('error-message'))
            })
    }
