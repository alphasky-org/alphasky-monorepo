...
namespace Alphasky\DataSynchronize\Exporter;

use Alphasky\Base\Facades\Assets;
use Alphasky\Base\Facades\BaseHelper;
use Alphasky\DataSynchronize\Concerns\Exporter\HasEmptyState;
use Alphasky\DataSynchronize\Enums\ExportColumnType;
use Carbon\Carbon;
...
abstract class Exporter implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithHeadings, WithMapping
{
    ...
    /**
     * @return \Alphasky\DataSynchronize\Exporter\ExportColumn[]
     */
    ...
    /**
     * @return \Alphasky\DataSynchronize\Exporter\ExportCounter[]
     */
