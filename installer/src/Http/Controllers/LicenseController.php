...
use Alphasky\Base\Exceptions\LicenseInvalidException;
use Alphasky\Base\Exceptions\LicenseIsAlreadyActivatedException;
use Alphasky\Base\Http\Controllers\BaseController;
use Alphasky\Base\Supports\Core;
use Alphasky\Setting\Facades\Setting;
use Alphasky\Setting\Http\Requests\LicenseSettingRequest;
use Carbon\Carbon;
