    ...
    handleModals() {
        ...
        _self.$body
            ...
            .on('click', '#modal-properties button[type="submit"]', (event) => {
                ...
                Alphasky.showButtonLoading($modal.find('button[type="submit"]'))
                ...
                ActionsService.processAction(
                    ...
                    () => {
                        $modal.modal('hide')
                        Alphasky.hideButtonLoading($modal.find('button[type="submit"]'))
        ...
        _self.$body
            ...
            .on('submit', '#modal_crop_image .form-crop', (event) => {
                ...
                Alphasky.showButtonLoading($form.find('button[type="submit"]'))
                ...
                ActionsService.processAction(
                    ...
                    (response) => {
                        ...
                        Alphasky.hideButtonLoading($form.find('button[type="submit"]'))
                    }
                )
            })
