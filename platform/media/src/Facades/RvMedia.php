...
namespace Alphasky\Media\Facades;

use Alphasky\Media\RvMedia as BaseRvMedia;
 ...
 * @method static bool deleteFile(\Alphasky\Media\Models\MediaFile $file)
 * @method static bool deleteThumbnails(\Alphasky\Media\Models\MediaFile $file)
 ...
 * @method static \Alphasky\Media\RvMedia addSize(string $name, string|int $width, string|int $height = 'auto')
 * @method static \Alphasky\Media\RvMedia removeSize(string $name)
 ...
 * @method static bool generateThumbnails(\Alphasky\Media\Models\MediaFile $file, \Illuminate\Http\UploadedFile|null $fileUpload = null)
 ...
 * @method static void renameFile(\Alphasky\Media\Models\MediaFile $file, string $newName, bool $renameOnDisk = true)
 * @method static void renameFolder(\Alphasky\Media\Models\MediaFolder $folder, string $newName, bool $renameOnDisk = true)
