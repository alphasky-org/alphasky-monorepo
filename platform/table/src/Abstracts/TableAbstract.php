...
namespace Alphasky\Table\Abstracts;
...
use Alphasky\Support\Repositories\Caches\CacheAbstractDecorator;
use Alphasky\Support\Repositories\Eloquent\RepositoriesAbstract;
use Alphasky\Table\Abstracts\Concerns\DeprecatedFunctions;
use Alphasky\Table\Abstracts\Concerns\HasActions;
use Alphasky\Table\Abstracts\Concerns\HasBulkActions;
use Alphasky\Table\Abstracts\Concerns\HasColumnVisibility;
use Alphasky\Table\Abstracts\Concerns\HasFilters;
use Alphasky\Table\Abstracts\Concerns\HasHeaderActions;
use Alphasky\Table\Columns\CheckboxColumn;
use Alphasky\Table\Columns\Column;
use Alphasky\Table\Columns\RowActionsColumn;
use Alphasky\Table\Contracts\FormattedColumn;
use Alphasky\Table\HeaderActions\HeaderAction;
use Alphasky\Table\Supports\Builder as CustomTableBuilder;
use Alphasky\Table\Supports\TableExportHandler;
use Closure;
...
abstract class TableAbstract extends DataTable implements ExtensibleContract
{
    ...
    /**
     * @var \Alphasky\Table\Columns\Column[]
     */
    ...
    public function getModel(): BaseModelContract|Model
    {
    ...
    /**
     * @param  \Alphasky\Table\Columns\Column[]  $columns
     */
