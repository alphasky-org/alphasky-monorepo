...
use Alphasky\Base\Forms\FieldOptions\OnOffFieldOption;
...
use Alphasky\Setting\Http\Requests\MediaSettingRequest;
        ...
        $this
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->placeholder('Ex: https://s3-ap-southeast-1.amazonaws.com/alphasky')
            )
            ->add(
                'media_aws_endpoint',
                TextField::class,
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->placeholder('Ex: https://alphasky.sfo2.digitaloceanspaces.com')
            )
            ->add(
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->placeholder('Ex: alphasky.b-cdn.net')
            )
            ->add(
                'media_bunnycdn_key',
                TextField::class,
