...
return [
    ...
    'email' => [
        ...
        'default_locale_helper' => 'Select the default language for member emails. When set to "Auto", the system will use the default site language. This prevents member emails from being sent in the staff member\'s dashboard language.',
