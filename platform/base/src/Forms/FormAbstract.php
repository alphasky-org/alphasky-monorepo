...
namespace Alphasky\Base\Forms;

use Alphasky\Base\Contracts\BaseModel;
use Alphasky\Base\Contracts\Builders\Extensible as ExtensibleContract;
use Alphasky\Base\Events\BeforeCreateContentEvent;
use Alphasky\Base\Events\BeforeEditContentEvent;
use Alphasky\Base\Events\BeforeUpdateContentEvent;
...
use Alphasky\Base\Forms\FieldOptions\SignatureFieldOption;
use Alphasky\Base\Forms\Fields\AutocompleteField;
use Alphasky\Base\Forms\Fields\ColorField;
use Alphasky\Base\Forms\Fields\DatePickerField;
use Alphasky\Base\Forms\Fields\DatetimeField;
use Alphasky\Base\Forms\Fields\EditorField;
use Alphasky\Base\Forms\Fields\HtmlField;
use Alphasky\Base\Forms\Fields\MediaFileField;
use Alphasky\Base\Forms\Fields\MediaImageField;
use Alphasky\Base\Forms\Fields\MediaImagesField;
use Alphasky\Base\Forms\Fields\MultiCheckListField;
use Alphasky\Base\Forms\Fields\OnOffCheckboxField;
use Alphasky\Base\Forms\Fields\OnOffField;
use Alphasky\Base\Forms\Fields\RadioField;
use Alphasky\Base\Forms\Fields\RepeaterField;
use Alphasky\Base\Forms\Fields\SelectField;
use Alphasky\Base\Forms\Fields\SignatureField;
use Alphasky\Base\Forms\Fields\TagField;
use Alphasky\Base\Forms\Fields\TimeField;
use Alphasky\Base\Forms\Fields\TimePickerField;
use Alphasky\Base\Models\BaseModel as BaseModelInstance;
use Alphasky\Base\Supports\Builders\Extensible;
use Alphasky\Base\Supports\Builders\RenderingExtensible;
use Alphasky\Base\Traits\Forms\HasCollapsible;
use Alphasky\Base\Traits\Forms\HasColumns;
use Alphasky\Base\Traits\Forms\HasFieldset;
use Alphasky\Base\Traits\Forms\HasMetaBoxes;
use Alphasky\Base\Traits\Forms\HasMetadata;
use Alphasky\Base\Traits\Forms\HasTabs;
use Alphasky\JsValidation\Facades\JsValidator;
use Alphasky\JsValidation\Javascript\JavascriptValidator;
use Closure;
...
abstract class FormAbstract extends Form implements ExtensibleContract
{
   ...
   protected array $breakField = [];
    ...
    public function setBreakField(string $breakField): static
    {
        $this->breakField[] = $breakField;
        return $this;
    }
        public function getBreakField(): array
    {
