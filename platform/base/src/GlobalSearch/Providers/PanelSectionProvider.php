...
namespace Alphasky\Base\GlobalSearch\Providers;

use Alphasky\Base\Facades\PanelSectionManager;
use Alphasky\Base\GlobalSearch\GlobalSearchableProvider;
use Alphasky\Base\GlobalSearch\GlobalSearchableResult;
