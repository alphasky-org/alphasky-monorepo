...
use Alphasky\Base\Exceptions\Handler;
...
use Alphasky\Base\GlobalSearch\GlobalSearchableManager;
use Alphasky\Base\Models\BaseModel;
use Alphasky\Base\PanelSections\Manager as PanelSectionManager;
use Alphasky\Base\PanelSections\System\SystemPanelSection;
use Alphasky\Base\Repositories\Eloquent\MetaBoxRepository;
use Alphasky\Base\Repositories\Interfaces\MetaBoxInterface;
use Alphasky\Base\Supports\Action;
...
use Alphasky\Base\Widgets\AdminWidget;
use Alphasky\Base\Widgets\Contracts\AdminWidget as AdminWidgetContract;
...
class BaseServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        config()->set(['session.cookie' => Str::slug(config('core.base.general.session_cookie', 'alphasky_session'), '_')]);
