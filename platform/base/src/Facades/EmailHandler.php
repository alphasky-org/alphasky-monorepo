...
use Alphasky\Base\Supports\EmailHandler as EmailHandlerSupport;
use Illuminate\Support\Facades\Facade;

/**
 * @method static \Alphasky\Base\Supports\EmailHandler setModule(string $module)
 * @method static string getType()
 * @method static \Alphasky\Base\Supports\EmailHandler setType(string $type)
 * @method static string|null getTemplate()
 * @method static \Alphasky\Base\Supports\EmailHandler setTemplate(string|null $template)
 * @method static array getCoreVariables()
 * @method static string getCssContent()
 * @method static array getIconVariables()
 * @method static \Alphasky\Base\Supports\EmailHandler setVariableValue(string $variable, array|string|null $value, string|null $module = null)
 * @method static array getVariableValues(string|null $module = null)
 * @method static \Alphasky\Base\Supports\EmailHandler setVariableValues(array $data, string|null $module = null)
 * @method static \Alphasky\Base\Supports\EmailHandler addTemplateSettings(string $module, array|null $data, string $type = 'plugins')
 * @method static \Alphasky\Base\Supports\EmailHandler removeTemplateSettings(string $module, string $type = 'plugins')
 ...
 *
 * @see \Alphasky\Base\Supports\EmailHandler
 */
