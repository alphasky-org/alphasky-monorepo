...
class PendingRequest {
    ...
    withButtonLoading(element) {
        this.beforeSend(() => Alphasky.showButtonLoading(element))
        this.completed(() => Alphasky.hideButtonLoading(element))

        return this
    }

    withLoading(element) {
        this.beforeSend(() => Alphasky.showLoading(element))
        this.completed(() => Alphasky.hideLoading(element))
    ...
    withDefaultErrorHandler() {
        this.errorHandlerUsing((error) => {
            ...
            switch (statusCode) {
                case 419:
                    Alphasky.showError('Session expired this page will reload in 5s.')
