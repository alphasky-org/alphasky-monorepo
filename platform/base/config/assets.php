    ...
    'resources'      => [
        'scripts' => [
            ...
            'report'             => [
                ...
                'location' => 'footer',
                'src'      => [
                    'local' => '/vendor/core/core/base/js/report.js',
                ],
            ],
            'survey'             => [
                'use_cdn'  => false,
                'location' => 'footer',
                'src'      => [
                    'local' => '/vendor/core/core/base/js/survey.js',
                ],
            ],
            'app'                => [
                'use_cdn'  => false,
            ...
            'daterangepicker'    => [
                ...
                'location' => 'footer',
                'src'      => [
                    'local' => '/vendor/core/core/base/libraries/daterangepicker/daterangepicker.js',
                ],
            ],
            'timepicker'         => [
                'use_cdn'  => false,
        ...
        'styles'  => [
            ...
            'report'             => [
                ...
                'location' => 'header',
                'src'      => [
                    'local' => '/vendor/core/core/base/css/report.css',
                ],
            ],
            'survey'             => [
                'use_cdn'  => false,
                'location' => 'header',
                'src'      => [
                    'local' => '/vendor/core/core/base/css/survey.css',
                ],
            ],
            'fontawesome'        => [
                'use_cdn'  => true,
            ...
            'daterangepicker'    => [
                ...
                'location' => 'footer',
                'src'      => [
                    'local' => '/vendor/core/core/base/libraries/daterangepicker/daterangepicker.css',
                ],
            ],
            'jqueryTree'         => [
                'use_cdn'  => false,
