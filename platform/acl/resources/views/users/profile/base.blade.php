...
@if ($canChangeProfile)
    @push('footer')
        {!! JsValidator::formRequest(Alphasky\ACL\Http\Requests\UpdateProfileRequest::class, '#profile-form') !!}
        {!! JsValidator::formRequest(Alphasky\ACL\Http\Requests\UpdatePasswordRequest::class, '#password-form') !!}
    @endpush
@endif
