            ...
            if (parentElement.length > 0) {
                ...
                $httpClient
                    ...
                    .then(({ data }) => {
                        ...
                        Alphasky.callScroll($('.list-page-select-widget'))
            ...
            .on('click', '.widget-control-delete', (event) => {
                ...
                $httpClient
                    ...
                    .then(({ data }) => {
                        ...
                        if (window.Alphasky) {
                            window.Alphasky.initResources()
                            window.Alphasky.initMediaIntegrate()
                            window.Alphasky.initCoreIcon()
                        }
                    ...
                    .finally(() => {
                        Alphasky.showButtonLoading(widget.find('.widget-control-delete'))
                    })
            })
