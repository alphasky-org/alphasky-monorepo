...
All notable changes to `alphasky/git-commit-checker` will be documented in this file.
...
- Fix output render on Windows platform (https://github.com/alphasky/git-commit-checker/pull/10)
