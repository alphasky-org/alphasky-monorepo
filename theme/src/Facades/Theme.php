...
use Alphasky\Theme\Theme as BaseTheme;
use Illuminate\Support\Facades\Facade;

/**
 * @method static \Alphasky\Theme\Theme layout(string $layout)
 * @method static \Alphasky\Theme\Theme uses(string|null $theme = null)
 * @method static \Alphasky\Theme\Theme theme(string|null $theme = null)
 ...
 * @method static \Alphasky\Theme\Theme setThemeName(string $theme)
 * @method static string getPublicThemeName()
 * @method static void fire(string $event, callable|object|array|string|null $args)
 * @method static \Alphasky\Theme\Breadcrumb breadcrumb()
 * @method static \Alphasky\Theme\Theme append(string $region, string $value)
 * @method static \Alphasky\Theme\Theme set(string $region, mixed|null $value)
 * @method static \Alphasky\Theme\Theme prepend(string $region, string $value)
 ...
 * @method static \Alphasky\Theme\Asset|\Alphasky\Theme\AssetContainer asset()
 * @method static \Alphasky\Theme\Theme ofWithLayout(string $view, array $args = [])
 * @method static \Alphasky\Theme\Theme of(string $view, array $args = [])
 * @method static mixed scope(string $view, array $args = [], $default = null)
 * @method static \Alphasky\Theme\Theme setUpContent(string $view, array $args = [])
 * @method static \Alphasky\Theme\Theme load(string $view, array $args = [])
 ...
 * @method static \Alphasky\Theme\Theme fireEventGlobalAssets()
