...
@section('content')
    <x-core::alert
        ...
        :important="false"
    >
            Those plugins are from our Alphasky community <a href="https://marketplace.alphasky.org/products" target="_blank">marketplace.alphasky.org/products</a>. We regret to inform
...
@push('footer')
    ...
    >
        <div class="text-start">
            <p>
                You are installing plugin from our Alphasky community. Those plugins are developed by author
                on <a href="https://marketplace.alphasky.org" target="_blank">marketplace.alphasky.org</a>.
            </p>
            <p>We (Alphasky) <strong>won't</strong> support free plugins from Marketplace.</p>
            <p>
