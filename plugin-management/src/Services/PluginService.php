...
use Alphasky\PluginManagement\Events\DeactivatedPlugin;
use Alphasky\PluginManagement\Events\RemovedPlugin;
use Alphasky\PluginManagement\Events\UpdatedPluginEvent;
use Alphasky\PluginManagement\Events\UpdatingPluginEvent;
use Alphasky\PluginManagement\PluginManifest;
...
class PluginService
{
    ...
    protected function isInBlacklist(string $plugin): bool
    {
        $blacklist = [
            'activator',
            'alphasky-activator',
            'alphasky-activator-main',
            'shaqi/alphasky-activator',
        ];
